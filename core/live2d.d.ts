...
declare class AMotion {
  ...
  protected updateParamExe(model: Live2DModelWebGL, time: number, weight: number, motionQueueEnt: Live2DObfuscated.MotionQueueEnt): void;
...
declare class Live2DMotion extends AMotion {
  ...
  updateParamExe(model: Live2DModelWebGL, time: number, weight: number, motionQueueEnt: Live2DObfuscated.MotionQueueEnt): void;
}
